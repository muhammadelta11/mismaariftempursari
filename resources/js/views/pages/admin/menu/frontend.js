            ...
            $('.dd').nestable({
                ...
                contentCallback: (item) => {
                    ...
                    const btn_update = can_update ?
                        `<button onclick="edit(${item.id})" class="btn turun btn-primary btn-sm"><span class="fas fa-edit"></span></button>` :
                        '';
                    const btn_delete = can_delete ?
                        `<button onclick="deleteFun(${item.id})" class="btn turun btn-danger btn-sm"><span class="fas fa-trash"></span></button>` :
                        '';
