<header data-anim="fade" data-add-bg="" class="header -type-3 -shadow bg-white js-header"
    style="box-shadow: 0px 0px 20px 0px #404f680d">
    
    @if ($notifikasi)
        @foreach ($notifikasi as $v)
            <div class="bg-green-5 py-10 notification_top">
                            ...
                            <div class="mobile-footer px-20 py-20 border-top-light js-mobile-footer">
                                <div class="mobile-footer__number">
                                    ...
                                    <div class="text-17 fw-500 text-purple-1">
                                        <a href="tel:+6285798132505">08527382816</a>
                                    </div>
                                </div>

                                <div class="lh-2 mt-10">
                                    <div>Kota Semarang,
                                        <br> Jawa Tengah 55212, Indonesia.
                                    </div>
                                    <div>
                                        <a href="mailto:hmjtiuwh@gmail.com">hmjtiuwh@gmail.com</a>
                                    </div>
                                </div>
                    ...
                    @if (auth()->user())
                        <div class="header-right__buttons d-flex items-center lg:d-none">
                            <a href="{{ route('dashboard') }}"
                                class="button h-50 px-30 -green-5 -rounded text-white ml-20">Halaman Administrator</a>
                        </div>
                    @else
                        <div class="header-right__buttons d-flex items-center lg:d-none">
                            <a href="{{ route('login') }}"
                                class="button h-50 px-30 -green-5 -rounded text-white ml-20">Masuk</a>
                        </div>
                    @endif
