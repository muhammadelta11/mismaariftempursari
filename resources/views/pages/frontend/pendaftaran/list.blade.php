                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body p-3">
                                    ...
                                    <hr class="my-1">
                                    <p>
                                        Pendaftaran pengurus HMJTI ini untuk mendokumentasikan data anggota dan untuk mempermudah
                                        komunikasi pengurus HMJTI terhadap anggota yang masih menjabat maupun alumni.
                                    </p>
                                </div>
                            </div>
                        </div>
