                ...
                <div class='bannerpost section' id='bannerpost' name='Cover Post Image'>
                    <div class='widget Image' data-version='2' id='Image13'>
                        <div class='widget-content'>
                            <div class='rcimg'>
                                <div class='rec-image'>
                                    <img alt='' class='lazyload' data-src="{{ asset('assets2/home/guru2.jpg') }}"  src="{{ asset('assets2/home/guru2.jpg') }}" />
                                </div>
                            </div>
                            <div class='sch-box2'>
                   ...
                   <div class='container'>
                    ...
                    <!-- <div class='teacherslider section' id='teacherslider' name='All Teacher'> -->
                        <div class='widget2 Image' data-version='2' id='Image17'>
                            <div class='widget2-content'>
                                <div class='rcimg'>
                                    <div class='rec-image2'>
                                    <a href="{{ $link_profile }}">
                                        <img onerror="this.src='{{ asset($image->default) }}';this.onerror='';"
                                        data-src="{{ $item->foto }}" alt="{{ $item->nama }}"  class='lazyload' data-sizes='auto' />
                                    </a>
                                    </div>
                                </div>
                                <div class='sch-box2'>
