...
@section('javascript')
    <script src="{{ asset_admin('datatables.net/2.1.1/jquery.dataTables.min.js') }}"></script>
    <script src="{{  asset('assets/templates/admin/plugins/datatable/js/dataTables.bootstrap5.min.jss') }}"></script>
    <script src="{{ asset_admin('jquery-loading-overlay/2.1.7/loadingoverlay.min.js', name: 'sash') }}"></script>
    <script src="{{ asset_admin('sweetalert2/11.10.3/sweetalert2.all.min.js', name: 'sash') }}"></script>
    @php
