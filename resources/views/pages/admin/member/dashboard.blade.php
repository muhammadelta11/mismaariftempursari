...
@section('content')
    ...
    <div class="grid mb-3">
                ...
                <div class="card radius-10 card-main">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="mb-0 text-secondary">Edit Profile</p>
                        </div>
                    </div>
                </div>
            </a>
                    ...
                    <div class="card radius-10 card-main">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <p class="mb-0 text-secondary">Input Kata Guru</p>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <div class="card radius-10 card-main">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="mb-0 text-secondary">Daftar Pengguna</p>
                        </div>
                    </div>
                </div>
            </a>
      ...
      @endif
        <div class="grid-item {{ $column }}">
            <a href="{{ route('admin.kepengurusan.periode') }}">
                <div class="card radius-10 card-main">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="widgets-icons rounded-circle mx-auto bg-light-primary text-secondary mb-3">
                                <i class="fas fa-sitemap"></i>
                            </div>
                            <p class="mb-0 text-secondary">Struktur Organisasi Sekolah</p>
                        </div>
                    </div>
                </div>
            </a>
                ...
                <div class="card radius-10 card-main">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <p class="mb-0 text-secondary">Artikel</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <!-- <div class="grid-item {{ $column }}">
            <a href="{{ route('admin.spk.ahp.perhitungan') }}">
                <div class="card radius-10 card-main">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="widgets-icons rounded-circle mx-auto bg-light-primary text-secondary mb-3">
                            ...
                            <p class="mb-0 text-secondary">Penilaian</p>
                        </div>
                    </div>
                </div>
            </a>
    ...
    <hr>
    <h5 class="page-title">Statistik Pengguna (Total: {{ $total_anggota }} Anggota)</h5>
    <div class="row">
        {{-- Angkatan --}}
            ...
            <div class="card">
                <div class="card-header d-md-flex flex-row justify-content-between">
                    <div>
                        ...
                        <small>Jumlah Pengguna berdasarkan tahun angkatan</small>
                    </div>
                    {{-- <div>
            ...
            <div class="card">
                <div class="card-header d-md-flex flex-row justify-content-between">
                    <div>
                        ...
                        <small>Jumlah Pengguna berdasarkan alamat</small>
                    </div>
                    {{-- <div>
                ...
                <div class="card">
                    <div class="card-header d-md-flex flex-row justify-content-between">
                        <div>
                            ...
                            <small>Statistik Pengguna Berdasarkan Riwayat Pendidikan</small>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped w-100 table-hover datatable" id="table{{ ++$jml_table }}">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card  m-lg-0">
                <div class="card-body">
                    <h6 class="card-title">Sistem Informasi Sekolah Madrasah (Khusus Pengguna)</h6>
                    <hr>
                    <h6 class="mb-0 mt-4">Profile</h6>
                    <ul class="list-style5">
                        <li>Management mendokumentasikan data Guru dan Informasi seolah. [selesai] <a href="{{ route('member.profile') }}">Kunjungi</a>
                        </li>
                    </ul>
            ...
            <div class="card m-lg-0">
                <div class="card-body">
                    ...
                    <ul class="list-style5">
                        ...
                        <li>Periode Kepengurusan (List Semua Periode Kepengurusan Sekolah)</li>
                    ...
                    <ul class="list-style5">
                        <li>List Semua Anggota Sekolah. [selesai] <a href="{{ route('anggota') }}">Kunjungi</a>
                        </li>
                    </ul>
                    ...
                    <ul class="list-style5">
                        <li>Sensus Anggota. [selesai] <a href="">Kunjungi</a>
                        </li>
                        <li>Poesaka</li>
                    ...
                    <ul class="list-style5">
                        <li>Halaman Untuk menghubungi administrator lewat website</li>
                    </ul>
                </div>
            </div>
        </div>
