            ...
            <div class="card" id="card-menu">
                <div class="card-body">
                    <div id="nestable-menu">
                        <div class="btn-group">
                            <button style=" margin-top: 40px;" class="btn me-1 btn-info btn-sm tree-tools" data-action="expand" title="Expand"
                                style="border: 0; border-radius: 4px">
                                <i class="fas fa-stream"></i>&nbsp;Expand
                            </button>
                            <button style=" margin-top: 40px;" class="btn me-1 btn-info btn-sm tree-tools" data-action="collapse" title="Collapse"
                                style="border: 0; border-radius: 4px">
                        ...
                        @if ($can_save)
                            <div class="btn-group">
                                <button style=" margin-top: 40px;" class="btn me-1 btn-primary btn-sm save" data-action="save" title="Save"
                        ...
                        <div class="btn-group">
                            <button style=" margin-top: 40px;" class="btn me-1 btn-warning btn-sm refresh" data-action="refresh" title="Refresh"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-md-flex flex-row justify-content-between">
                                ...
                                @if ($can_insert)
                                    <div>
                                        <button style=" margin-top: 40px;" class="btn btn-rounded btn-danger btn-sm" id="menu-btn-cancel"
                            ...
                            <div class="text-end">
                                <button type="submit" style=" margin-top: 40px;" class="btn btn-primary" id="btn-save" form="menu-form">
