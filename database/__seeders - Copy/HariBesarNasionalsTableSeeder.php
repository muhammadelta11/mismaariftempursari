...
class HariBesarNasionalsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('hari_besar_nasionals')->updateOrInsert([
            'id' => '1',
        ], [
            'type' => '1',
            'hari' => '1',
        ...
        DB::table('hari_besar_nasionals')->updateOrInsert([
            ...
            'bulan' => '2',
            'tahun' => NULL,
            'nama' => 'Hari Peristiwa Kapal Tujuh Provinsi (Zeven ProvinciÃƒÂ«n)',
            'keterangan' => '',
            'created_at' => NULL,
            'updated_at' => NULL,
        ]);
        ...
        DB::table('hari_besar_nasionals')->updateOrInsert([
            ...
            'keterangan' => 'Hari Air Sedunia (Inggris: World Day for Water) adalah perayaan yang ditujukan sebagai usaha-usaha menarik perhatian publik akan pentingnya air bersih dan usaha penyadaran untuk pengelolaan sumber-sumber air bersih yang berkelanjutan.Hari Air Sedunia diperingati setiap tanggal 22 Maret, inisiatif peringatan ini di umumkan pada Sidang Umum PBB ke-47 tanggal 22 Desember 1992 di Rio de Janeiro, Brasil.Setiap tahunnya pada Hari Air Sedunia terdapat tema khusus, contohnya pada 2009 Ã¢â‚¬Å“Air Bersama, Peluang BersamaÃ¢â‚¬Â (Shared water, shared opportunities).Untuk Tahun 2016 tema yang diambil adalah Water and Jobs, yang memberikan penjelasan tentang hubungannya air dan pekerjaan yang dimiliki. Hal penting lain yang akan disampaikan adalah bahwa dengan kuantitas dan kualitas air yang lebih baik berhubungan dengan pekerjaan yang lebih baik pula.',
            'created_at' => NULL,
            'updated_at' => NULL,
        ]);
        DB::table('hari_besar_nasionals')->updateOrInsert([
        ...
        DB::table('hari_besar_nasionals')->updateOrInsert([
            ...
            'keterangan' => 'Hari Kebebasan Pers Sedunia dirayakan setiap 3 Mei. Hari ini biasanya diperingati untuk membela media dari sejumlah bahaya yang mengancam kemerdekaan pers, juga mengenang para jurnalis yang gugur dalam melakukan pekerjaannya. Hari Pers Dunia diresmikan oleh Organisasi Pendidikan, Keilmuan, dan Kebudayaan PBB (UNESCO) pada 1993 setelah rekomendasi dari konferensi umum dua tahun sebelumnya.Ã‚Â  Diselenggarakan seusai Perang Dingin, mereka ingin memastikan negara-negara Afrika menjadi lebih demokratis dan mengutamakan hak asasi manusia. Salah satunya dengan tidak membatasi pergerakan media melalui intimidasi, pengungkungan, dan sensor.',
            'created_at' => NULL,
            'updated_at' => NULL,
        ]);
        DB::table('hari_besar_nasionals')->updateOrInsert([
            ...
            'keterangan' => 'International FirefightersÃ¢â‚¬â„¢ Day (IFFD) diperingati setiap tanggal 4 Mei. Sebelumnya usulan ini dikirimkan melalui email ke seluruh dunia pada tanggal 4 Januari 1999 untuk mengenang empat orang pemadam kebakaran yang bernasib tragis saat mencoba memadamkan kebakaran hebat di Australia. Tanggal 4 Mei diperingati sebagai FirefightersÃ¢â‚¬â„¢ Day dibanyak negara Eropa.International FirefightersÃ¢â‚¬â„¢ Day (IFFD) merupakan waktu bagi warga dunia untuk memberikan penghargaan atas pengorbanan para pemadam kebakaran yang telah berjasa menyelamatkan masyarakat dan lingkungan. Di hari tersebut, biasanya juga diberikan penghargaan kepada mantan pemadam kebakaran yang telah memberikan kontibusinya bagi masyarakat.',
            'created_at' => NULL,
            'updated_at' => NULL,
        ]);
        DB::table('hari_besar_nasionals')->updateOrInsert([
        ...
        DB::table('hari_besar_nasionals')->updateOrInsert([
            ...
            'bulan' => '2',
            'tahun' => '2023',
            'nama' => 'Isra dan MiÃ¢â‚¬â„¢raj Nabi Muhammad SAW (Islam)',
            'keterangan' => '',
            'created_at' => NULL,
