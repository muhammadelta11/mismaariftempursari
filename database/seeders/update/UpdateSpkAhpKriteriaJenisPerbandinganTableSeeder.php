...
class UpdateSpkAhpKriteriaJenisPerbandinganTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        // Ambil data terbaru dari tabel spk_ahp_kriteria_jenis_perbandingan
        $perbandingans = DB::table('spk_ahp_kriteria_jenis_perbandingan')->get();
        ...
        foreach ($perbandingans as $perbandingan) {
            $seederContent .= "        DB::table('spk_ahp_kriteria_jenis_perbandingan')->updateOrInsert([\n";
        ...
        File::put(database_path('seeders/SpkAhpKriteriaJenisPerbandinganTableSeeder.php'), $seederContent);
    }
}
