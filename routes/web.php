...
// use App\Http\Controllers\Frontend\About\SambutanController;
...
Route::group(['prefix' => $name], function () use ($name) {
    ...
    // Route::get('/sambutan', [SambutanController::class, 'index'])->name("$name.sambutan");
});
// ====================================================================================================================
